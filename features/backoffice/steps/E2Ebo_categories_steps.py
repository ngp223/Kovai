...
def step_create_category(context):
    ...
    context.role_name=f"ROLQA{timestamp}"
    context.categories_page.create_category(context.category_name)

@then("creo un rol")
def step_create_role(context):
    context.categories_page.create_role(context.role_name)
...
def step_modify_category(context):
    context.categories_page.modify_category(context.category_name,context.modified_category_name)
...
@then("elimino el rol")
def step_delete_role(context):
    context.categories_page.delete_role(context.role_name)
