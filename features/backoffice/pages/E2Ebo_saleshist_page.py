...
class SalesPage_bo(BasePage):
    ...
    SALES_MENU = (By.XPATH,"//a[.//span[normalize-space()='Historial Ventas']]")
    RESTAURANT_SELECT = (By.CSS_SELECTOR,"select")
    EXPORT_CSV_BTN = (By.XPATH,"//button[contains(.,'Exportar CSV')]")
    ...
    def select_restaurant(self, restaurant_name):
        ...
        Select(select_element).select_by_visible_text(restaurant_name)
