...
class TablesPage_bo(BasePage):
    ...
    def create_table(self):
        ...
        WebDriverWait(self.driver,10).until(
            lambda d:
            len(d.find_elements(*self.TABLE)) == before + 1
        )
    ...
    def delete_rate(self):
        ...
        rate = WebDriverWait(self.driver,10).until(
            EC.visibility_of_element_located(
                (
                    By.XPATH,
                    f"//div[.//span[contains(normalize-space(),'{self.rate_name}')]]"
                )
            )
        )


        delete_btn = rate.find_element(
            By.XPATH,
        ...
        try:
            ...
            confirm = WebDriverWait(self.driver,5).until(
                EC.element_to_be_clickable(
                    (
                        By.XPATH,
                        "//button[contains(@class,'_confirmButton_') and contains(normalize-space(),'Eliminar')]"
                    )
                )
            )
    ...
    def delete_zone(self):
        ...
        # coge el primer contenedor padre que contiene el botón eliminar
        ...
        confirm = WebDriverWait(self.driver,10).until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "//button[contains(@class,'_confirmButton_12xoa_95') and normalize-space()='Eliminar']"
                )
            )
        )
