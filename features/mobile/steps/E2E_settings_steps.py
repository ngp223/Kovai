...
@then("desactivo la cola de pedidos QR")
def step_impl(context):
    context.settings_page.desactivar_cola_pedidos_qr()


@then("activo la cola de pedidos QR")
def step_impl(context):
    context.settings_page.activar_cola_pedidos_qr()


@then("cambio el tamaño de texto a mediana")
def step_impl(context):
    context.settings_page.deshacer_cambiar_accesibilidad()


@then("cambio el idioma a español")
def step_impl(context):
    context.settings_page.deshacer_cambiar_idioma()


@then("cambio el aspecto a claro")
def step_impl(context):
    context.settings_page.deshacer_cambiar_aspecto()
